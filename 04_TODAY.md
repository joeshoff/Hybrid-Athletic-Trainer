# TODAY — Current Week Dashboard

This is the short-term planning artifact. It holds the actual day-by-day prescriptions for the current week only — not the permanent program. Durable rules live in 01_MASTER_PROGRAM.md (strength/program) and 03_CARDIO_PLAN.md (cardio framework and decision workflow). SmartGym holds the executed history.
